...
import {SceneOptionsInterface} from "./scene-options.interface";
...
export class Scene implements SceneInterface {
    ...
    constructor(options: SceneOptionsInterface) {
    ...
    private drawText(sceneObject: SceneObject): void {
    ...
    private drawTexture(sceneObject: SceneObject): void {
    ...
    private drawCircle(sceneObject: SceneObject): void {
        this.context.arc(
            sceneObject.position.x,
            sceneObject.position.y,
    ...
    private drawEclipse(sceneObject: SceneObject): void {
        if (sceneObject.size.width < sceneObject.size.height) {
            this.context.translate(sceneObject.position.x, sceneObject.position.y);
    ...
    private drawRect(sceneObject: SceneObject): void {
