...
export default class Core {
    ...
    public appendScene(options: { name: string, scene: Scene }): void {
        options.scene.setActiveScene = this.setActiveScene.bind(this);
        this.scenes[options.name] = options.scene;
    }
